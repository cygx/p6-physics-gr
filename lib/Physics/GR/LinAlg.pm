...
package Physics::GR {
    ...
    enum IndexType <COVARIANT CONTRAVARIANT>;

    role Tensor does Algebraic {
        method rank { ... }
        method shape { ... }
        method type { ... }
        method dimension { ... }
    ...
    role Vectorial[\TYPE] does Tensor {
        has $.components;
    ...
    class Vector does Vectorial[CONTRAVARIANT] {
    ...
    class Covector does Vectorial[COVARIANT] {
        multi method gist(::?CLASS:D:) {
    ...
    class HomogeneousTensor does Tensor {
        has $.elements;
        has $.dimension;
        has $.type;
...
sub EXPORT {
    BEGIN Map.new((
        Tensor => Physics::GR::Tensor,
        Skalar => Physics::GR::Skalar,
        Vectorial => Physics::GR::Vectorial,
        Vector => Physics::GR::Vector,
        Covector => Physics::GR::Covector,
        Matrix => Physics::GR::Matrix,
        HomogeneousTensor => Physics::GR::HomogeneousTensor,
    ));
}
